...
{
    $curl = curl_init();
    $token = "Mx8ziEeldhxSeHcLYp2fzlOlmNkxhSPr4uJA8meMdYPnu55RVzQ6c1BKugRhNWGB";
    $data = [
...
//fungsi api wa untuk kirim gambar
function api_sendwa_image($no_wa, $fileurl, $caption)
{
    $curl = curl_init();
    $token = "Mx8ziEeldhxSeHcLYp2fzlOlmNkxhSPr4uJA8meMdYPnu55RVzQ6c1BKugRhNWGB";
    $data = [
