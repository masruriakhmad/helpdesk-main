...
<body>
    <div class="row" style="height: 100%">
        <div class="col-lg-12">
                ...
                <form action="<?php echo $action; ?>" method="post">
                    <div class="ibox-content">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                <label for="int">Group <?php echo form_error('id_group') ?></label>
            ...
            <select type="text" class="form-control" name="id_kecamatan" id="id_kecamatan" placeholder="Kecamatan" value="<?php echo $id_kecamatan; ?>" />
        ...
        <div class="form-group">
            ...
            <select type="text" class="form-control" name="id_desa" id="id_desa" placeholder="Desa" value="<?php echo $id_desa; ?>" />
                <option value="<?php echo $id_desa; ?>"><?php echo $nama_desa; ?></option>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                <label for="varchar">Nomor WA <?php echo form_error('telp') ?></label>
                                <input type="text" class="form-control numeric" name="telp" id="telp" placeholder="Nomor WA" value="<?php echo $telp; ?>" />
                            </div>
                            <div class="form-group">
