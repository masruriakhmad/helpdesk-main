...
<body>
    ...
    <!-- Jquery Validate -->
    <script src="<?= base_url() ?>assets/vendor/inspinia/js/plugins/validate/jquery.validate.min.js"></script>
    ...
    <script>
        ...
        //fungsi mendisable text area tindaklanjut
        function loadtindaklanjut() {
            var tindaklanjut = $("#deskripsi_tindaklanjut").val();
            var penyelesaian = $("#deskripsi_penyelesaian").val();

            if (tindaklanjut != '') {
                $("#deskripsi_tindaklanjut").hide();
                $("#baris_isian_tindaklanjut").hide();
                $("#deskripsi_penyelesaian").show();

            } else {
                $("#deskripsi_tindaklanjut").show();
                $("#baris_isian_penyelesaian").hide();
                $("#deskripsi_penyelesaian").hide();
                $("#btn").hide();
            }
        }
        ...
        //fungis load kecamatan pelapor
        function loadkecamatan() {
            var id_kecamatan = '';
            $.ajax({
                type: "GET",
                dataType: "JSON",
                url: "<?= base_url(); ?>Pengaduan/get_kecamatan",
                data: {},
                success: function(data) {
                    ...
                    $("#id_kecamatan_pelapor").html(html);
                    $("#id_kecamatan_korban").html(html);
                }
            });
        }
        ...
        function loaddesa_pelapor() {
            ...
            $("#id_kecamatan_pelapor").change(function() {
                ...
                $.ajax({
                    ...
                    data: {
                        kecamatan: getkecamatan_pelapor
                    },
        ...
        function loaddesa_kejadian() {
            ...
            $("#id_kecamatan_kejadian").change(function() {
                ...
                $.ajax({
                    ...
                    url: "<?= base_url(); ?>Pengaduan/get_desa",
                    data: {
                        kecamatan: getkecamatan_kejadian
                    },
        ...
        function readURL_ktp_pelapor(input) {
        ...
        $("#preview").change(function() {
            readURL_ktp_pelapor(this);

        });

        function readURL_ktp_korban(input) {
            if (input.files && input.files[0]) {
                var reader = new FileReader();
                reader.onload = function(e) {
